...
public class GroupMemberAdapter extends BaseAdapter {
    ...
    private List<ProfileHeadInfo> list;
    ...
    public GroupMemberAdapter(Context context, int showMemberLimit) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_grid_group_member, parent, false);
        ...
        ImageView avatarView = viewHolder.avatarView;
        ...
        if (position == getCount() - 1 && (isAllowDelete || isAllowAdd)) {
            ...
            final ProfileHeadInfo groupMember = list.get(position);
            String groupNickName = groupMember.getName();
...
//            String portraitUri = GlideImageLoaderUtil.getScString(groupMember.getUserIcon());
...
//            }
            GlideImageLoaderUtil.loadCircleImage(parent.getContext(),avatarView,groupMember.getUserIcon());
    ...
    @Override
    public ProfileHeadInfo getItem(int position) {
     ...
     * 传入新的数据 刷新UI的方法
     */
    public void updateListView(List<ProfileHeadInfo> list) {
    ...
    public interface OnItemClickedListener {
         ...
         * @param groupMember
         */
        void onMemberClicked(ProfileHeadInfo groupMember);
    }
